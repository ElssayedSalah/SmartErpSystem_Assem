...
{
    public class DebitSettlementTransactionController : BaseAdminController
    {
        ...
        public void IntializeDropdowens()
        {
            ...
            var transSettings = _TransactionsEntrySettingService.GetWithCondetion(x => x.DocTypeId == (int)DocumentTypes.DebitSettlementTransaction).FirstOrDefault();
        ...
        public void SetBasicButtonsVisibilityForCreate()
        {
            ...
            ViewData["BasicButtons"] = new BasicButtons() { CreateNewBtnControler = "DebitSettlementTransaction", CreateNewBtnAction = "Create", BackToListControler = "DebitSettlementTransaction", BackToListAction = "Index", EditBtnControler = "DebitSettlementTransaction", EditBtnAction = "Edit", DeleteBtnControler = "DebitSettlementTransaction", DeleteBtnAction = "Delete", RouteId = 0, CreateNewBtnVisibilty = true, EditBtnVisibilty = false, BackToListBtnVisibilty = true, SaveBtnVisibilty = true, DeleteBtnVisibilty = false, PrintBtnVisibilty = false };

        }

        public void SetBasicButtonsVisibilityForEdit(int RouteId)
        {
            ViewData["BasicButtons"] = new BasicButtons() { CreateNewBtnControler = "DebitSettlementTransaction", CreateNewBtnAction = "Create", BackToListControler = "DebitSettlementTransaction", BackToListAction = "Index", EditBtnControler = "DebitSettlementTransaction", EditBtnAction = "Edit", DeleteBtnControler = "DebitSettlementTransaction", DeleteBtnAction = "Delete", RouteId = RouteId, CreateNewBtnVisibilty = true, EditBtnVisibilty = false, BackToListBtnVisibilty = true, SaveBtnVisibilty = true, DeleteBtnVisibilty = true, PrintBtnVisibilty = true, PrintBtnControler = "DebitSettlementTransaction", PrintBtnAction = "Print" };
        }
        public IActionResult Index()
        {
            if (!_identityService.Authorize(StandardPermissionProvider.ManageDebitSettlementTransaction.SystemName, CurrentUser, PermissionActions.List))
        ...
        {
            var transactions = _CashTransactionService.GetWithCondetion(x => x.FinancialPeriodId == CurrentUser.FinancialPeriodId && x.CompanyId == CurrentUser.CompanyId && x.DocTypeId == (int)DocumentTypes.DebitSettlementTransaction);
            var branches = _BranchService.GetAll();
        ...
        {
            //if (!_identityService.Authorize(StandardPermissionProvider.ManageDebitSettlementTransaction.SystemName, CurrentUser, PermissionActions.Create))
            //   return AccessDeniedView();

            var LastCode = _CashTransactionService.GetLastCode(o => o.Code, x => x.FinancialPeriodId == CurrentUser.FinancialPeriodId && x.DocTypeId == (int)DocumentTypes.DebitSettlementTransaction && x.CompanyId == CurrentUser.CompanyId);
        ...
        public IActionResult Create([Bind] CashTransactionModel model)
        {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (!_CashTransactionService.IsExistRecord(b => b.Code == model.Code && b.FinancialPeriodId == currentUser.FinancialPeriodId && b.DocTypeId == (int)DocumentTypes.DebitSettlementTransaction && b.CompanyId == CurrentUser.CompanyId))
                    {
                        master = _Mapper.Map<CashTransaction>(model);
                        master.SetBasicData(CRUD_OperationType.Create, (int)DocumentTypes.DebitSettlementTransaction, currentUser);
        ...
        {
            //if (!_identityService.Authorize(StandardPermissionProvider.ManageDebitSettlementTransaction.SystemName, CurrentUser, PermissionActions.Edit))
            // return AccessDeniedView();
        ...
        public IActionResult Edit(CashTransactionModel model)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    master.SetBasicData(SharedEnums.CRUD_OperationType.Update, (int)DocumentTypes.DebitSettlementTransaction, CurrentUser); var SystemSetting = _SystemSettingService.GetAll().FirstOrDefault();
        ...
        public IActionResult Delete(int Id)
        {
            try
            {
                //if (!_identityService.Authorize(StandardPermissionProvider.ManageDebitSettlementTransaction.SystemName, CurrentUser, PermissionActions.Delete))
        ...
        public void AddEntry(TransactionEntrySetting transactionSettings, int DocNumber, int CuruncyId, decimal CuruncyFactor, decimal Amount, decimal DiscountAmount, int DiscountAccountId, out int EntryNumber, out int EntryId)
        {
            ...
            if (transactionSettings != null)
            {
                ...
                EntryMaster.DocType = (int)DocumentTypes.DebitSettlementTransaction;
                ...
                EntryMaster.SetBasicData(CRUD_OperationType.Create, (int)DocumentTypes.DebitSettlementTransaction, CurrentUser);
                #endregion
        ...
        public void UpdateEntry(TransactionEntrySetting transactionSettings, int DocNumber, int CuruncyId, decimal CuruncyFactor, decimal Amount, decimal DiscountAmount, int DiscountAccountId, int EntryId)
        {
            ...
            if (transactionSettings != null)
            {
                ...
                if (oldEntryMaster != null)
                {
                    ...
                    oldEntryMaster.SetBasicData(CRUD_OperationType.Update, (int)DocumentTypes.DebitSettlementTransaction, CurrentUser);
                    #endregion
