...
{
    public partial class BankStatementOfAccountReport
    {
        private static LocalizationService _LocalizationService;

        public BankStatementOfAccountReport(LocalizationService localizationService)
        {
            InitializeComponent();
            _LocalizationService = localizationService;

        }         
        private void BankStatementOfAccountReport_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            bankHedarFilter.Text = _LocalizationService.GetLocalizedHtmlString("BankModel").Value;
            ...
            var datasource = this.DataSource as System.Collections.Generic.List<BankStatementOfAccountReportDs>;
