...
{
    public partial class WriteCheckOutRptPrint
    {       
        private static LocalizationService _LocalizationService;
        public WriteCheckOutRptPrint(LocalizationService localizationService)
        {
            InitializeComponent();
        ...
        private void WriteCheckOutRptPrint_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            Bank.Text = _LocalizationService.GetLocalizedHtmlString("Bank").Value;
