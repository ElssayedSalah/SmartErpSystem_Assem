...
{
    public partial class CheckOutExchangeRptPrint
    {       
        private static LocalizationService _LocalizationService;
        public CheckOutExchangeRptPrint(LocalizationService localizationService)
        {
            InitializeComponent();
        ...
        private void CheckOutExchangeRptPrint_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            Bank.Text = _LocalizationService.GetLocalizedHtmlString("BankModel").Value;
            DueDate.Text = _LocalizationService.GetLocalizedHtmlString("DueDate").Value;
            CheckNumber.Text = _LocalizationService.GetLocalizedHtmlString("CheckNumber").Value;
