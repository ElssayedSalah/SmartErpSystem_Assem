...
{
    public partial class AddToStoreRptPrint
    {
        private static LocalizationService _LocalizationService;

        public AddToStoreRptPrint(LocalizationService localizationService)
        {
            InitializeComponent();
        ...
        private void AddToStorePrint_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            SupplerName.Text = _LocalizationService.GetLocalizedHtmlString("Suppler").Value;
